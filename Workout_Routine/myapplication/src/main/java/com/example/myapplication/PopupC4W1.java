...
public class PopupC4W1 extends AppCompatActivity {
        ...
        if (exorcise.equals("Front Squat")) {
            ...
            OL_FS.setOnClickListener(new View.OnClickListener(){
                ...
                public void onClick(View view){
                    ...
                    Intent intent = new Intent(PopupC4W1.this, C4W1Activity.class);
    ...
    public void no(View view) {
        Intent intent = new Intent(PopupC4W1.this, C3W1Activity.class);
        startActivity(intent);
    }
}