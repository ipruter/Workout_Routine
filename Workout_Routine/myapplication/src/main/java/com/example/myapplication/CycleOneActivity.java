...
public class CycleOneActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        OL_FS = (Button) findViewById(R.id.OL2);
        OL_CPU = (Button) findViewById(R.id.OL3);
        OL_OAPU = (Button) findViewById(R.id.OL4);
        OL_AP = (Button) findViewById(R.id.OL5);
        OL_PS = (Button) findViewById(R.id.OL6);
        OL_OAIR = (Button) findViewById(R.id.OL7);
        OL_PU = (Button) findViewById(R.id.OL8);
        OL_SU = (Button) findViewById(R.id.OL9);
        OL_FS2 = (Button) findViewById(R.id.OL10);
        OL_DL2 = (Button) findViewById(R.id.OL11);
        OL_CR = (Button) findViewById(R.id.OL12);
        OL_AP2 = (Button) findViewById(R.id.OL13);
        OL_OAPU2 = (Button) findViewById(R.id.OL14);
        OL_SU2 = (Button) findViewById(R.id.OL15);
        OL_PU2 = (Button) findViewById(R.id.OL16);
        OL_OAIR2 = (Button) findViewById(R.id.OL17);
        OL_MU = (Button) findViewById(R.id.OL18);
        ...
        });OL_FS2.setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View view){
        ...
        });OL_DL2.setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View view){
        ...
        OL_AP2.setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View view){
        ...
        OL_OAPU2.setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View view){
        ...
        OL_SU2.setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View view){
        ...
        OL_PU2.setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View view){
        ...
        OL_OAIR2.setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View view){
        ...
        if(cal_push_up == "0"){
            ...
            tv_CPU_int.setText(String.valueOf(df.format(Math.round(get_pullup_intensity(body_weight, cal_push_up_max)))));
            tv_CPU_rep.setText(String.valueOf(df.format(get_reps(Math.round(get_pullup_intensity(body_weight, cal_push_up_max))))));
        ...
        if(OA_push_up == "0"){
            ...
            if(body_weight > OA_push_up75){
                tv_OAPU_int.setText(String.valueOf(df.format(Math.round(get_pushup_intensity(body_weight, sit_up_max)))));
