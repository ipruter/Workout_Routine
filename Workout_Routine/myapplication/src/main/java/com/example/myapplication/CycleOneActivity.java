...
public class CycleOneActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (front_squat == "0") {
            ...
            double ol_front_squat75 = overload(front_squat75);

            // Adjusts reps and intensity if body weight exceeds expected weight
            if (body_weight > front_squat75) {
                tv_FS_int.setText(String.valueOf(df.format(Math.round(get_squat_intensity(body_weight, ol_squat_max)))));
                tv_FS_rep.setText(String.valueOf(df.format(get_reps(Math.round(get_squat_intensity(body_weight, ol_squat_max))))));
                tv_FS.setText(String.valueOf(df.format(body_weight * 0.72)));
            } else {
                // Set weight and reps
                ol_front_squat75 = squat_body_weight(body_weight, ol_front_squat75); // Factors body weight
                ol_front_squat75 = round_five(ol_front_squat75); // Round by five
                tv_FS.setText(String.valueOf(df.format(ol_front_squat75)));
        ...
        if (dead_lift == "0") {
            ...
            double ol_dead_lift83 = overload(dead_lift83);

            // Adjusts reps and intensity if body weight exceeds expected weight
            if (body_weight > dead_lift83) {
                tv_DL2_int.setText(String.valueOf(df.format(Math.round(get_squat_intensity(body_weight, ol_deadlift_max)))));
                tv_DL2_rep.setText(String.valueOf(df.format(get_reps(Math.round(get_squat_intensity(body_weight, ol_deadlift_max))))));
                tv_DL2.setText(String.valueOf(df.format(body_weight * 0.72)));
            }
            else {
                // Set weight and reps
                ol_dead_lift83 = squat_body_weight(body_weight, ol_dead_lift83); // Factors body weight
                ol_dead_lift83 = round_five(ol_dead_lift83); // Round by five
                tv_DL2.setText(String.valueOf(df.format(ol_dead_lift83)));
        ...
        if (sit_up == "0") {
            ...
            double ol_sit_up75 = overload(sit_up75);

            // Adjusts reps and intensity if body weight exceeds expected weight
            if (body_weight > sit_up75) {
                tv_SU_int.setText(String.valueOf(df.format(Math.round(get_pushup_intensity(body_weight, ol_sit_up_max)))));
                tv_SU_rep.setText(String.valueOf(df.format(get_reps(Math.round(get_pushup_intensity(body_weight, ol_sit_up_max))))));
                tv_SU.setText(String.valueOf(df.format(body_weight * 0.5)));
            }
            else {
                // Set weight and reps
                ol_sit_up75 = pushup_body_weight(body_weight, ol_sit_up75); // Factors body weight
                ol_sit_up75 = round_five(ol_sit_up75); // Round by five
                tv_SU.setText(String.valueOf(df.format(ol_sit_up75)));
        ...
        if (OA_push_up == "0") {
            ...
            double ol_OA_push_up83 = overload(OA_push_up83);

            // Adjusts reps and intensity if body weight exceeds expected weight
            if (body_weight > OA_push_up83) {
                tv_OAPU2_int.setText(String.valueOf(df.format(Math.round(get_pushup_intensity(body_weight, ol_OA_push_up_max)))));
                tv_OAPU2_rep.setText(String.valueOf(df.format(get_reps(Math.round(get_pushup_intensity(body_weight, ol_OA_push_up_max))))));
                tv_OAPU2.setText(String.valueOf(df.format(body_weight * 0.5)));
            }
            else {
                // Set weight and reps
                ol_OA_push_up83 = pushup_body_weight(body_weight, ol_OA_push_up83); // Factors body weight
                ol_OA_push_up83 = round_five(ol_OA_push_up83); // Round by five
                tv_OAPU2.setText(String.valueOf(df.format(ol_OA_push_up83)));
        ...
        if (axel_press == "0") {
            ...
            double ol_axel_press75 = overload(axel_press75);
            ol_axel_press75 = round_five(ol_axel_press75); // Round weight
            tv_AP.setText(String.valueOf(df.format(ol_axel_press75))); // Set weight
        ...
        if (OAI_row == "0") {
            ...
            double ol_OAI_row83 = overload(OAI_row83);

            // Adjusts reps and intensity if body weight exceeds expected weight
            if (body_weight > OAI_row83) {
                tv_OAIR2_int.setText(String.valueOf(df.format(Math.round(get_pushup_intensity(body_weight, ol_OAI_row_max)))));
                tv_OAIR2_rep.setText(String.valueOf(df.format(get_reps(Math.round(get_pushup_intensity(body_weight, ol_OAI_row_max))))));
                tv_OAIR2.setText(String.valueOf(df.format(body_weight * 0.5)));
            }
            else {
                // Set weight and reps
                ol_OAI_row83 = pushup_body_weight(body_weight, ol_OAI_row83); // Factors body weight
                ol_OAI_row83 = round_five(ol_OAI_row83); // Round by five
                tv_OAIR2.setText(String.valueOf(df.format(ol_OAI_row83)));
        ...
        if (pull_up == "0") {
            ...
            double ol_pull_up75 = overload(pull_up75);

            // Adjusts reps and intensity if body weight exceeds expected weight
            if (body_weight > pull_up75) {
                tv_PU_int.setText(String.valueOf(df.format(Math.round(get_pullup_intensity(body_weight, ol_pull_up_max)))));
                tv_PU_rep.setText(String.valueOf(df.format(get_reps(Math.round(get_pullup_intensity(body_weight, ol_pull_up_max))))));
                tv_PU.setText(String.valueOf(df.format(body_weight)));
            }
            else {
                // Set weight and reps
                ol_pull_up75 = pullup_body_weight(body_weight, ol_pull_up75); // Factors body weight
                ol_pull_up75 = round_two_point_five(ol_pull_up75); // Round by five
                tv_PU.setText(String.valueOf(df.format(ol_pull_up75)));
    ...
    public void popup_FS(View view) {
        Intent intent = new Intent(CycleOneActivity.this, popup.class);
